...
export const enum IpcEvents {
    ...
    ARIA2_DOWNLOAD = "VCD_ARIA2_DOWNLOAD",
    ARIA2_AVAILABLE = "VCD_ARIA2_AVAILABLE",
    TRANSFER_NG_UPLOAD = "VCD_TRANSFER_NG_UPLOAD",
    TRANSFER_NG_CHECK = "VCD_TRANSFER_NG_CHECK",
    TRANSFER_NG_PROGRESS = "VCD_TRANSFER_NG_PROGRESS",
